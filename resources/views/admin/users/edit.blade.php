...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center">
            <input type="checkbox" id="has_sandwich_bar" name="has_sandwich_bar" value="1" {{ old('has_sandwich_bar', $user->has_sandwich_bar) ? 'checked' : '' }}
        ...
        <div class="flex space-x-4 pt-4">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-colors focus:ring-2 focus:ring-blue-500">
                Update User
            </button>
